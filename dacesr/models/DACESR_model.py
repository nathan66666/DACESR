...
from DACESR.basicsr.models.srgan_ram_model import SRGAN_RAM_Model
...
class DACESR_Model(SRGAN_RAM_Model):
    def __init__(self, opt):
        super(DACESR_Model, self).__init__(opt)
    ...
    def feed_data(self, data_all):
        if self.is_train:
            ...
            if self.degradation_degree == 'severe_degrade_two_stage':
                ...
                self.lq_ram = transforms.functional.normalize(lr_image_ram, mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DACESR_Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
