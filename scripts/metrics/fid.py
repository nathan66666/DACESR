...
if __name__ == "__main__":
    ...
    print(fid_value)
    # python /lxy/DASR/scripts/metrics/fid.py --p1 /lxy/DASR/datasets/RealSR_CenterCrop/test_HR --p2 /lxy/DASR/results/test_DVMSR_archived_20241024_101020/visualization/RealSR_CenterCrop --batch-size 1
    # /lxy/DASR/datasets/DIV2K_val_realsr
    # /lxy/DASR/results/test_DVMSR_archived_20241024_101020/visualization/DIV2K_val_realsr

    # /lxy/DASR/datasets/DrealSR_CenterCrop
    # /lxy/DASR/results/test_DVMSR_archived_20241024_101020/visualization/DrealSR_CenterCrop

    # /lxy/DASR/datasets/RealSR_CenterCrop
    # /lxy/DASR/results/test_DVMSR_archived_20241024_101020/visualization/RealSR_CenterCrop